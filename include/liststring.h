...
/* String adalah integer */

#ifndef _H_LIST_STRING
#define _H_LIST_STRING
...
typedef struct StringtElmtlist* Stringaddress;
typedef struct StringtElmtlist {
	String info;
	Stringaddress next;
} StringElmtList;
typedef struct {
...
/* Lout adalah StringList kosong jika ada alokasi elemen yang gagal */
